...
#define MAP(X)                                                          \
  ...
  X(KW_WHILE, "WHILE", 4)                                               \
  X(KW_WRITE, "WRITE", 4)                                               \
  X(PG_000_LB, "<prgm grammar enum lower bound>", 1)                    \
  ...
  X(PG_ZZZ_UB, "<prgm grammar enum upper bound>", 1)                    \
  X(SG_ACCESS_ID, "access-id", 1)                                       \
  X(SG_ACCESS_ID_LIST, "access-id-list", 1)                             \
  X(SG_ACCESS_SPEC, "access-spec", 1)                                   \
  X(SG_ACCESS_STMT, "access-stmt", 1)                                   \
  X(SG_ACTION_STMT, "action-stmt", 1)                                   \
  ...
  X(SG_ALLOCATABLE_STMT, "allocatable-stmt", 1)                         \
  ...
  X(SG_ALLOCATE_STMT, "allocate-stmt", 1)                               \
  ...
  X(SG_ARITHMETIC_IF_STMT, "arithmetic-if-stmt", 1)                     \
  X(SG_ARRAY_ELEMENT, "array-element", 1)                               \
  X(SG_ARRAY_SPEC, "array-spec", 1)                                     \
  X(SG_ARRAY_SPEC_LIST, "array-spec-list", 2)                           \
  X(SG_ASSIGNMENT_STMT, "assignment-stmt", 1)                           \
  X(SG_ASSOCIATE_STMT, "associate-stmt", 1)                             \
  ...
  X(SG_ASYNCHRONOUS_STMT, "asynchronous-stmt", 1)                       \
  X(SG_ATTR_SPEC, "attr-spec", 1)                                       \
  X(SG_BACKSPACE_STMT, "backspace-stmt", 2)                             \
  X(SG_BINDING_ATTR, "binding-attr", 1)                                 \
  X(SG_BINDING_ATTR_LIST, "binding-attr-list", 1)                       \
  X(SG_BINDING_NAME_LIST, "binding-name-list", 1)                       \
  X(SG_BINDING_PRIVATE_STMT, "binding-private-stmt", 1)                 \
  X(SG_BIND_STMT, "bind-stmt", 1)                                       \
  X(SG_BLOCK_STMT, "block-stmt", 1)                                     \
  ...
  X(SG_CLOSE_STMT, "close-stmt", 2)                                     \
  X(SG_COARRAY_SPEC, "coarray-spec", 1)                                 \
  X(SG_CODIMENSION_STMT, "codimension-stmt", 1)                         \
  ...
  X(SG_COMMON_STMT, "common-stmt", 1)                                   \
  ...
  X(SG_COMPONENT_DEF_STMT, "component-def-stmt", 1)                     \
  ...
  X(SG_COMPUTED_GOTO_STMT, "computed-goto-stmt", 1)                     \
  ...
  X(SG_CONTAINS_STMT, "contains-stmt", 1)                               \
  X(SG_CONTINUE_STMT, "continue-stmt", 1)                               \
  X(SG_COSUBSCRIPT, "cosubscript", 1)                                   \
  X(SG_COSUBSCRIPT_LIST, "cosubscript-list", 1)                         \
  X(SG_CYCLE_STMT, "cycle-stmt", 1)                                     \
  X(SG_DATA_COMPONENT_DEF_STMT, "data-component-def-stmt", 1)           \
  ...
  X(SG_DEALLOCATE_STMT, "deallocate-stmt", 1)                           \
  ...
  X(SG_DERIVED_TYPE_STMT, "derived-type-stmt", 1)                       \
  X(SG_DESIGNATOR, "designator", 1)                                     \
  X(SG_DIMENSION_STMT, "dimension-stmt", 1)                             \
  X(SG_DO_STMT, "do-stmt", 1)                                           \
  X(SG_DUMMY_ARG, "dummy-arg", 1)                                       \
  X(SG_DUMMY_ARG_LIST, "dummy-arg-list", 1)                             \
  X(SG_DUMMY_ARG_NAME_LIST, "dummy-arg-name-list", 1)                   \
  X(SG_ELSEWHERE_STMT, "elsewhere-stmt", 1)                             \
  X(SG_ELSE_IF_STMT, "else-if-stmt", 1)                                 \
  X(SG_ELSE_STMT, "else-stmt", 1)                                       \
  X(SG_ENDFILE_STMT, "endfile-stmt", 2)                                 \
  X(SG_END_ASSOCIATE_STMT, "end-associate-stmt", 1)                     \
  X(SG_END_BLOCK_STMT, "end-block-stmt", 1)                             \
  X(SG_END_DO, "end-do", 1)                                             \
  X(SG_END_DO_STMT, "end-do-stmt", 1)                                   \
  X(SG_END_ENUM_STMT, "end-enum-stmt", 1)                               \
  X(SG_END_FORALL_STMT, "end-forall-stmt", 1)                           \
  X(SG_END_FUNCTION_STMT, "end-function-stmt", 1)                       \
  X(SG_END_IF_STMT, "end-if-stmt", 1)                                   \
  X(SG_END_INTERFACE_STMT, "end-interface-stmt", 1)                     \
  X(SG_END_MODULE_STMT, "end-module-stmt", 1)                           \
  X(SG_END_MP_SUBPROGRAM_STMT, "end-mp-subprogram-stmt", 1)             \
  X(SG_END_PROGRAM_STMT, "end-program-stmt", 1)                         \
  X(SG_END_SELECT_STMT, "end-select-stmt", 1)                           \
  X(SG_END_SELECT_RANK_STMT, "end-select-rank-stmt", 1)                 \
  X(SG_END_SELECT_TYPE_STMT, "end-select-type-stmt", 1)                 \
  X(SG_END_SUBMODULE_STMT, "end-submodule-stmt", 1)                     \
  X(SG_END_SUBROUTINE_STMT, "end-subroutine-stmt", 1)                   \
  X(SG_END_TYPE_STMT, "end-type-stmt", 1)                               \
  X(SG_END_WHERE_STMT, "end-where-stmt", 1)                             \
  X(SG_ENTITY_DECL, "entity-decl", 1)                                   \
  X(SG_ENTITY_DECL_LIST, "entity-decl-list", 1)                         \
  X(SG_ENTRY_STMT, "entry-stmt", 1)                                     \
  X(SG_ENUMERATOR, "enumerator", 1)                                     \
  X(SG_ENUMERATOR_DEF_STMT, "enumerator-def-stmt", 1)                   \
  X(SG_ENUMERATOR_LIST, "enumerator-list", 1)                           \
  X(SG_ENUM_DEF_STMT, "enum-def-stmt", 1)                               \
  ...
  X(SG_EQUIVALENCE_STMT, "equivalence-stmt", 1)                         \
  X(SG_EQUIV_OP, "equiv-op", 1)                                         \
  X(SG_ERROR_STOP_STMT, "error-stop-stmt", 1)                           \
  X(SG_EVENT_POST_STMT, "event-post-stmt", 1)                           \
  X(SG_EVENT_WAIT_STMT, "event-wait-stmt", 1)                           \
  X(SG_EXIT_STMT, "exit-stmt", 1)                                       \
  ...
  X(SG_EXTERNAL_STMT, "external-stmt", 1)                               \
  X(SG_FAIL_IMAGE_STMT, "fail-image-stmt", 1)                           \
  X(SG_FINAL_PROCEDURE_STMT, "final-procedure-stmt", 1)                 \
  X(SG_FINAL_SUBROUTINE_NAME_LIST, "final-subroutine-name-list", 1)     \
  X(SG_FLUSH_STMT, "flush-stmt", 2)                                     \
  X(SG_FORALL_ASSIGNMENT_STMT, "forall-assignment-stmt", 1)             \
  X(SG_FORALL_CONSTRUCT_STMT, "forall-construct-stmt", 1)               \
  X(SG_FORALL_STMT, "forall-stmt", 1)                                   \
  X(SG_FORMAT, "format", 1)                                             \
  X(SG_FORMAT_SPECIFICATION, "format-specification", 2)                 \
  X(SG_FORMAT_STMT, "format-stmt", 1)                                   \
  X(SG_FORM_TEAM_STMT, "form-team-stmt", 1)                             \
  X(SG_FUNCTION_REFERENCE, "function-reference", 1)                     \
  X(SG_FUNCTION_STMT, "function-stmt", 1)                               \
  X(SG_GENERIC_SPEC, "generic-spec", 1)                                 \
  X(SG_GOTO_STMT, "goto-stmt", 1)                                       \
  X(SG_IF_STMT, "if-stmt", 1)                                           \
  X(SG_IF_THEN_STMT, "if-then-stmt", 1)                                 \
  ...
  X(SG_IMPLICIT_STMT, "implicit-stmt", 1)                               \
  ...
  X(SG_IMPORT_STMT, "import-stmt", 1)                                   \
  ...
  X(SG_LABEL, "label", 1)                                               \
  X(SG_LABEL_DO_STMT, "label-do-stmt", 1)                               \
  ...
  X(SG_MACRO_STMT, "macro-stmt", 1)                                     \
  X(SG_MASKED_ELSEWHERE_STMT, "masked-elsewhere-stmt", 1)               \
  X(SG_MODULE_NATURE, "module-nature", 1)                               \
  X(SG_MODULE_STMT, "module-stmt", 1)                                   \
  X(SG_MP_SUBPROGRAM_STMT, "mp-subprogram-stmt", 1)                     \
  ...
  X(SG_NAMELIST_STMT, "namelist-stmt", 1)                               \
  X(SG_NONLABEL_DO_STMT, "nonlabel-do-stmt", 1)                         \
  X(SG_NULLIFY_STMT, "nullify-stmt", 1)                                 \
  X(SG_NULL_INIT, "null-init", 1)                                       \
  X(SG_OBJECT_NAME_LIST, "object-name-list", 1)                         \
  X(SG_ONLY, "only", 1)                                                 \
  X(SG_ONLY_LIST, "only-list", 1)                                       \
  X(SG_OPEN_STMT, "open-stmt", 2)                                       \
  X(SG_OPTIONAL_STMT, "optional-stmt", 1)                               \
  X(SG_OTHER_SPECIFICATION_STMT, "other-specification-stmt", 1)         \
  X(SG_OUTPUT_ITEM, "output-item", 1)                                   \
  X(SG_OUTPUT_ITEM_LIST, "output-item-list", 1)                         \
  X(SG_PARAMETER_STMT, "parameter-stmt", 1)                             \
  ...
  X(SG_PRINT_STMT, "print-stmt", 1)                                     \
  X(SG_PRIVATE_COMPONENTS_STMT, "private-components-stmt", 1)           \
  X(SG_PRIVATE_OR_SEQUENCE, "private-or-sequence", 1)                   \
  X(SG_PROCEDURE_DECLARATION_STMT, "procedure-declaration-stmt", 1)     \
  X(SG_PROCEDURE_DESIGNATOR, "procedure-designator", 1)                 \
  X(SG_PROCEDURE_STMT, "procedure-stmt", 1)                             \
  ...
  X(SG_PROC_COMPONENT_DEF_STMT, "proc-component-def-stmt", 1)           \
  ...
  X(SG_PROGRAM_STMT, "program-stmt", 1)                                 \
  X(SG_PROTECTED_STMT, "protected-stmt", 1)                             \
  X(SG_READ_STMT, "read-stmt", 1)                                       \
  X(SG_REAL_LITERAL_CONSTANT, "real-literal-constant", 2)               \
  X(SG_REL_OP, "rel-op", 1)                                             \
  X(SG_RENAME, "rename", 1)                                             \
  X(SG_RENAME_LIST, "rename-list", 1)                                   \
  X(SG_RETURN_STMT, "return-stmt", 1)                                   \
  X(SG_REWIND_STMT, "rewind-stmt", 2)                                   \
  X(SG_SAVED_ENTITY, "saved-entity", 1)                                 \
  X(SG_SAVED_ENTITY_LIST, "saved-entity-list", 1)                       \
  X(SG_SAVE_STMT, "save-stmt", 1)                                       \
  X(SG_SECTION_SUBSCRIPT, "section-subscript", 1)                       \
  X(SG_SECTION_SUBSCRIPT_LIST, "section-subscript-list", 1)             \
  X(SG_SELECTOR, "selector", 1)                                         \
  X(SG_SELECT_CASE_STMT, "select-case-stmt", 1)                         \
  X(SG_SELECT_RANK_STMT, "select-rank-stmt", 1)                         \
  X(SG_SELECT_RANK_CASE_STMT, "select-rank-case-stmt", 1)               \
  X(SG_SELECT_TYPE_STMT, "select-type-stmt", 1)                         \
  X(SG_SEQUENCE_STMT, "sequence-stmt", 1)                               \
  X(SG_SIGN, "sign", 1)                                                 \
  X(SG_SPECIFIC_PROCEDURE, "specific-procedure", 1)                     \
  X(SG_SPECIFIC_PROCEDURE_LIST, "specific-procedure-list", 1)           \
  X(SG_STOP_STMT, "stop-stmt", 1)                                       \
  X(SG_STRUCTURE_COMPONENT, "structure-component", 1)                   \
  X(SG_STRUCTURE_CONSTRUCTOR, "structure-constructor", 1)               \
  X(SG_SUBMODULE_STMT, "submodule-stmt", 1)                             \
  X(SG_SUBROUTINE_STMT, "subroutine-stmt", 1)                           \
  X(SG_SUBSTRING, "substring", 1)                                       \
  X(SG_SUBSTRING_RANGE, "substring-range", 1)                           \
  X(SG_SUFFIX, "suffix", 1)                                             \
  X(SG_SYNC_ALL_STMT, "sync-all-stmt", 1)                               \
  X(SG_SYNC_IMAGES_STMT, "sync-images-stmt", 1)                         \
  X(SG_SYNC_MEMORY_STMT, "sync-memory-stmt", 1)                         \
  X(SG_SYNC_TEAM_STMT, "sync-team-stmt", 1)                             \
  X(SG_TARGET_DECL, "target-decl", 1)                                   \
  X(SG_TARGET_DECL_LIST, "target-decl-list", 1)                         \
  X(SG_TARGET_STMT, "target-stmt", 1)                                   \
  X(SG_TYPE_ATTR_SPEC, "type-attr-spec", 1)                             \
  X(SG_TYPE_ATTR_SPEC_LIST, "type-attr-spec-list", 1)                   \
  X(SG_TYPE_BOUND_GENERIC_STMT, "type-bound-generic-stmt", 1)           \
  X(SG_TYPE_BOUND_PROCEDURE_STMT, "type-bound-procedure-stmt", 1)       \
  ...
  X(SG_TYPE_DECLARATION_STMT, "type-declaration-stmt", 1)               \
  X(SG_TYPE_GUARD_STMT, "type-guard-stmt", 1)                           \
  ...
  X(SG_TYPE_PARAM_DEF_STMT, "type-param-def-stmt", 1)                   \
  ...
  X(SG_UNLOCK_STMT, "unlock-stmt", 1)                                   \
  X(SG_UPPER_BOUND_EXPR, "upper-bound-expr", 1)                         \
  X(SG_USE_STMT, "use-stmt", 1)                                         \
  X(SG_VALUE_STMT, "value-stmt", 1)                                     \
  X(SG_VARIABLE, "variable", 1)                                         \
  X(SG_VARIABLE_NAME, "variable-name", 1)                               \
  X(SG_VARIABLE_NAME_LIST, "variable-name-list", 1)                     \
  X(SG_VOLATILE_STMT, "volatile-stmt", 1)                               \
  X(SG_WAIT_STMT, "wait-stmt", 1)                                       \
  X(SG_WHERE_CONSTRUCT_STMT, "where-construct-stmt", 1)                 \
  X(SG_WHERE_STMT, "where-stmt", 1)                                     \
  X(SG_WRITE_STMT, "write-stmt", 1)                                     \
  X(TK_AND_OP, ".AND.", 3)                                              \
  X(TK_ARROW, "=>", 3)                                                  \
  X(TK_ASTERISK, "*", 3)                                                \
  X(TK_BRACKETL, "[", 3)                                                \
